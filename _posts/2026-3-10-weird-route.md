...
\
on line 8 we see  ```snd_play(snd_ominous);``` snd_ominous is the weird route jingle, in almost every situation hearing this means that you're advancing the weird route
